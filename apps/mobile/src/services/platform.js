...
const appendExpoFilePart = (form, fieldName, asset) => {
  ...
  // Expo SDK 57's File constructor expects a File/Directory or path segments.
  // Passing a content:// URI directly can cross the native boundary as a released
  // shared object on Android. Use the URI-based factory for picker assets instead.
