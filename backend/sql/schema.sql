...
CREATE TABLE polls (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,chat_id BIGINT UNSIGNED NOT NULL,creator_id BIGINT UNSIGNED NOT NULL,question VARCHAR(500) NOT NULL,multiple_choice TINYINT(1) NOT NULL DEFAULT 0,anonymous TINYINT(1) NOT NULL DEFAULT 0,created_at DATETIME NOT NULL,closes_at DATETIME NULL,closed_at DATETIME NULL,INDEX(chat_id)) ENGINE=InnoDB;
...
CREATE TABLE stories (id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,user_id BIGINT UNSIGNED NOT NULL,type VARCHAR(30) NOT NULL,content TEXT NOT NULL,audience VARCHAR(40) NOT NULL DEFAULT 'friends',created_at DATETIME NOT NULL,expires_at DATETIME NOT NULL,deleted_at DATETIME NULL,INDEX(user_id),INDEX(expires_at)) ENGINE=InnoDB;
