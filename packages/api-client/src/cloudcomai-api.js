...
export class CloudComAiApi {
  ...
  joinPublicChat(roomId, options = {}) { return this.client.post(ApiRoute.PUBLIC_CHATS, { action: 'join', room_id: roomId }, options); }
  leavePublicChat(roomId, options = {}) { return this.client.post(ApiRoute.PUBLIC_CHATS, { action: 'leave', room_id: roomId }, options); }
